...
contract ICORefferal {
    string public name = 'ICO Refferal';
    ...
    constructor(address _treasuryAddress, IERC20 _withdrawToken) {
        owner = msg.sender;
    ...
    function verifyMessage(
        ...
        bytes32 hashedMessage = keccak256(
            abi.encode(_value, _sender, _timeout, nonce[_sender]++)
        );
    ...
    function withdrawPermit(
        ...
        require(
            verifyMessage(_amount, _address, _timeout, _v, _r, _s),
            'Not Accepted'
        );
        ...
        // Transfer token
        IERC20(withdrawToken).transferFrom(treasuryAddress, _address, _amount);
